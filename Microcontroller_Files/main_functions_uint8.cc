...
// Bringing interpreter from micro_speech
  ...
  error_reporter->Report("model_inpu=%d", interpreter.input(0));
...
//error_reporter->Report("Softmax: clock_alarm=%d, cat=%d, door_knock=%d, clapping=%d, footsteps=%d, dog=%d, laughing=%d, glass_breaking%d", 
//silence_score, unknown_score, footsteps_score, glassbreaking_score, doorknock_score, clapping_score, dog_score, clock_alarm_score);
